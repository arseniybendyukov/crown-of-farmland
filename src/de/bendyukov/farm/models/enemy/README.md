...
Some parts of the game use **reverse-weighted selection**.

Here, **smaller original weights are more likely to be selected**, while the **largest original weight cannot be selected**.

This is used when strong values should be less likely to be chosen.
